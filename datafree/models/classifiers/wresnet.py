...
class WideResNet(nn.Module):
    def __init__(self, depth, num_classes, widen_factor=1, dropout_rate=0.0,  args = None):
        ...
        if args is not None:
            self.register_buffer('pre_features', torch.zeros(args.batch_size, self.nChannels))
...
def wrn_16_1(num_classes, dropout_rate=0, args = None):
    return WideResNet(depth=16, num_classes=num_classes, widen_factor=1, dropout_rate=dropout_rate,args= args)

def wrn_16_2(num_classes, dropout_rate=0, args = None):
    return WideResNet(depth=16, num_classes=num_classes, widen_factor=2, dropout_rate=dropout_rate, args = args)

def wrn_40_1(num_classes, dropout_rate=0, args = None):
    return WideResNet(depth=40, num_classes=num_classes, widen_factor=1, dropout_rate=dropout_rate,args=args)

def wrn_40_2(num_classes, dropout_rate=0, args = None):
    return WideResNet(depth=40, num_classes=num_classes, widen_factor=2, dropout_rate=dropout_rate, args = args)